...
class Location(object):
    ...
    def calc_sun_position(self, latitude_deg, longitude_deg, year, month, hoy):
        """
        ...
        start_of_year = datetime.datetime(year, month, 15, 0, 0, 0, 0)
        # utc_datetime = start_of_year + datetime.timedelta(hours=hoy) #this has to be changed cus we have 15 minutes intervals instead of hours
        
        utc_datetime = start_of_year + datetime.timedelta(minutes = hoy * 15) 
